    ...
    def emit(self, record):
        for X in ["OSError", "TimeoutError"]:
            if X in record.getMessage():
                os.system(f"kill -9 {os.getpid()} && python3 -m zall")
...
class Bot(Client):
    def __init__(self, **kwargs):
        super().__init__(**kwargs, device_model="ekik jembut")
...
from zall.core.function import *
from zall.core.helpers import *